    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // program.m3u8 (single-tier legacy) and {tier}/program.m3u8
                // (multi-tier) carry the per-viewer signed license URL
                // rewritten at request time, so both must be authenticated.
